...
> The scope-fidelity command described below has been retired. Its source is
> recoverable from the revision recorded in [repository cleanup](../repository-cleanup.md); it is not a current setup or CI step.
