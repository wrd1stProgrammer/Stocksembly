...
- Credit allocation: Free receives a one-time 4-credit sign-up grant; Pro receives 150 credits per month; Ultra receives 400 credits per month. The allowance is a visible value row on each card, while the feature list explains the outcome of the plan.
...
- Plan copy: Free communicates the one-time 4-credit starting balance; Pro communicates selectable research options, free access to research after seven days, and daily briefings for three watchlist names; Ultra communicates ten-name daily briefings and early access to new features.
