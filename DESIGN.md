...
- Personal work seats use `(seat)/(input)/facing`: Maya `(4,6)/(4,5)/up`; June `(8,6)/(8,5)/up`; Alex `(12,6)/(12,5)/up`; Ethan `(31,6)/(31,5)/up`; Aria `(35,6)/(35,5)/up`; Leo `(39,6)/(39,5)/up`; Noah `(4,24)/(4,23)/up`; Sofia `(9,24)/(9,23)/up`; Hana `(14,24)/(14,23)/up`; Liam `(32,23)/(32,22)/up`; Min `(36,23)/(36,22)/up`. Meeting seats retain the current table composition: Maya `(8,7)/(8,8)/down`; June `(7,11)/(7,10)/up`; Alex `(9,11)/(9,10)/up`; Ethan `(35,7)/(35,8)/down`; Aria `(34,11)/(34,10)/up`; Leo `(37,11)/(37,10)/up`; Noah `(7,24)/(7,25)/down`; Sofia `(11,24)/(11,25)/down`; Hana `(9,28)/(9,27)/up`; Liam `(31,24)/(31,25)/down`; Min `(34,28)/(34,27)/up`. Dr. Park remains `(22,11)/(22,10)/up`.
...
- Department furniture is generated from the same manifest as nine independent Pixi clusters: four image-generated personal workstation banks, four compact procedural meeting tables, and Dr. Park's chair desk. The workstation banks encode each team's actual headcount (Market/Company/Financial `3`, Risk `2`) and include the desk and PC surface; persistent direction-specific chair sprites remain separate so their backrests can pass in front of a seated actor without flattening the character into the raster. Meeting tables keep their own persistent chairs and tabletop laptops. Furniture entries declare `purpose: workstation | meeting | chair`, and only the matching seat group is attached to that cluster. Furniture footprints are physical obstacles; every personal seat, meeting seat, door, visitor anchor, and cross-room route remains walkable and unobstructed.
