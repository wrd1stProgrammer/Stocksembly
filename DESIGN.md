...
- Personal work seats use `(seat)/(input)/facing`: Maya `(4,13)/(4,14)/down`; June `(8,13)/(8,14)/down`; Alex `(12,13)/(12,14)/down`; Ethan `(31,13)/(31,14)/down`; Aria `(35,13)/(35,14)/down`; Leo `(39,13)/(39,14)/down`; Noah `(5,30)/(5,31)/down`; Sofia `(9,30)/(9,31)/down`; Hana `(13,30)/(13,31)/down`; Liam `(31,30)/(31,31)/down`; Min `(35,30)/(35,31)/down`. Meeting seats retain the current table composition: Maya `(8,7)/(8,8)/down`; June `(7,11)/(7,10)/up`; Alex `(9,11)/(9,10)/up`; Ethan `(35,7)/(35,8)/down`; Aria `(34,11)/(34,10)/up`; Leo `(37,11)/(37,10)/up`; Noah `(7,24)/(7,25)/down`; Sofia `(11,24)/(11,25)/down`; Hana `(9,28)/(9,27)/up`; Liam `(31,24)/(31,25)/down`; Min `(34,28)/(34,27)/up`. Dr. Park remains `(22,11)/(22,10)/up`.
