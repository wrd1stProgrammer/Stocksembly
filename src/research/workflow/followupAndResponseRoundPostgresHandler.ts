...
import type { FollowupAndResponseRoundPostgresAuthority } from "./followupAndResponseRoundPostgresAuthority";
...
type HandlerContext = {
  ...
  readonly roundAuthority: FollowupAndResponseRoundPostgresAuthority;
  ...
  const execute = async (
    ...
    const job =
      logicalArtifactId === undefined
        ? undefined
        : await context.roundAuthority.loadJob(
            attempt.runId,
            logicalArtifactId,
          );
